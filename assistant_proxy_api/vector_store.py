"""
Модуль работы с векторным хранилищем ChromaDB для ProxiAPI.
...
class VectorStore:
    """Векторное хранилище на основе ChromaDB с ProxiAPI embeddings."""
    ...
    def load_documents(self, file_path: str):
        ...
        for i, chunk in enumerate(chunks):
            # Создание embedding через ProxiAPI
    ...
    def _create_embedding(self, text: str) -> List[float]:
        """
        Создание векторного представления текста через ProxiAPI.
        ...
        Returns:
            вектор embeddings
        """
        embeddings = self.proxy_client.get_embeddings([text])
        return embeddings[0]
